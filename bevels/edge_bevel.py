...
from .. lib.polling import is_edit_mode, has_edges_selected, object_is_mesh
...
CTRL — Remove existing modifiers"""
    ...
    def poll(cls, context):
        ...
        return is_edit_mode(context) and object_is_mesh(target_object) and has_edges_selected(target_object)
